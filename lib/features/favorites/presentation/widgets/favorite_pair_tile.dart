...
/// Elevated card tile rendering a saved favorite currency pair with Deep Plum and Neon Glow styling.
class FavoritePairTile extends StatelessWidget {
  final FavoritePairEntity pair;
  ...
  Widget _buildDualFlags(
      BuildContext context, String fromCode, String toCode) {
  ...
  Widget _buildDeltaBadge(double percent) {
    ...
    final textColor =
        isPositive ? AppColors.deltaPositive : AppColors.deltaNegative;
