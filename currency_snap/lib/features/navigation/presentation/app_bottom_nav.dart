import 'package:currency_snap/core/theme/app_colors.dart';
        ...
        child: NavigationBar(
          ...
          destinations: [
            NavigationDestination(
              icon: Icon(CupertinoIcons.house, color: inactiveColor, size: 22),
            ...
            NavigationDestination(
              icon: Icon(CupertinoIcons.star, color: inactiveColor, size: 22),
              selectedIcon: const Icon(
            ...
            NavigationDestination(
              icon: Icon(CupertinoIcons.clock, color: inactiveColor, size: 22),
              selectedIcon: const Icon(
            ...
            NavigationDestination(
              icon: Icon(CupertinoIcons.gear, color: inactiveColor, size: 22),
              selectedIcon: const Icon(
